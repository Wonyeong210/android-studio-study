...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rg_gender.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // RadioButton 들의 상태값의 변경됨을 감지
            @Override
        ...
        btn_result.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(str_result != null) {
                    ...
                    Toast.makeText(MainActivity.this, "라디오 버튼을 선택하시오", Toast.LENGTH_SHORT).show();
                }
            }
        });
